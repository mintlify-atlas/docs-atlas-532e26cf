---
title: "PojavLauncher: Play Minecraft Java Edition on Android"
sidebarTitle: "Introduction"
description: "Open-source Minecraft: Java Edition launcher for Android — supports Forge, Fabric, multi-JRE, custom controls, and every version from rd-132211 to 1.21."
---
...
| Project | License |
|---|---|
| [Boardwalk](https://github.com/zhuowei/Boardwalk) — JVM launcher foundation | Unknown / Apache 2.0 or GNU GPLv2 |
...
| [pro-grade](https://github.com/pro-grade/pro-grade) — Java sandboxing security manager | Apache 2.0 |
