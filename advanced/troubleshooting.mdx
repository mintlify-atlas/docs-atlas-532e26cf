---
title: "Troubleshooting Common PojavLauncher Issues"
sidebarTitle: "Troubleshooting"
description: "Fix crashes, black screens, slow downloads, oversized controls, Forge failures, input lag, and login errors in PojavLauncher with step-by-step solutions."
---
...
1. Go to **Settings → Video → Renderer** and switch to a different backend:
   - If you were using `vulkan_zink`, try `opengles3`.
   - If you were using `opengles3`, try `opengles2`.
