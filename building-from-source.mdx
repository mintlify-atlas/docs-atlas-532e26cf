---
title: "Building PojavLauncher from Source on Android"
...
<Note>
  Gradle downloads around 4 GB of JVM args headroom is allocated (`-Xmx4096M`). Make sure your machine has at least 4 GB of RAM available for the build daemon.
</Note>
...
| `assembleProguard` | Debug variant with ProGuard minification enabled |
| `assembleGplay` | Google Play release variant (requires keystore environment variables) |
