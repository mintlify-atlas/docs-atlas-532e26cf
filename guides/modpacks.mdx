...
description: "Browse and install Minecraft modpacks from Modrinth and CurseForge directly inside PojavLauncher for Android, with full manifest and hash verification."
---
...
From the PojavLauncher main menu, tap the **Modpacks** button. The browser opens with a unified search bar and a filter button. Searches run against both Modrinth and CurseForge simultaneously, and results are interleaved in a single list sorted by relevance.
